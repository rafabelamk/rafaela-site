...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section id="home" className="relative bg-[#0d1b3e] pt-20 pb-10 lg:pt-16 lg:pb-12 px-5 sm:px-8 overflow-hidden">
      ...
      {/* O QUE EU ENTREGO */}
      <section className="bg-[#060f22] py-14 px-5 sm:px-8 relative overflow-hidden">
      ...
      {/* MÉTODO ADS */}
      <section id="metodo" className="bg-[#0d1b3e] py-14 px-5 sm:px-8 relative overflow-hidden">
