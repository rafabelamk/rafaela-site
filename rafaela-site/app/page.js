...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section id="home" className="relative bg-[#0d1b3e] pt-16 pb-6 lg:pt-10 lg:pb-8 px-5 sm:px-8 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-start">
            ...
            {/* Mockup desktop */}
            <div className="hidden lg:flex justify-center items-start overflow-hidden" style={{height:'320px'}}>
