...
const STATS = [
  ...
  { value: 'R$300K+', label: 'Em negócios locais' },
...
const LOGOS = [
  ...
  { name: 'Fiori Empreendimentos', file: '/logos/fiori.png' },
  { name: 'Orsegups', file: '/logos/orsegups.png' },
  { name: 'Olhar Negócios Imobiliários', file: '/logos/olhar.png' },
]
...
const FAQ_DATA = [
  ...
  { q: 'Qual o investimento mínimo em anúncios para ter resultados?',
    a: 'Varia conforme o nicho e objetivo. Na consultoria inicial, defino junto com você um orçamento realista para o seu momento.' },
  ...
  { q: 'Como funciona o contrato e o pagamento?',
    a: 'Trabalho com contrato mensal, sem fidelidade de longo prazo, com escopo e valores alinhados na proposta.' },
]

const TIPS_CAPTION = `1. Não existe campanha perfeita, existe estratégia e otimização contínua.

2. Tráfego não serve só pra trazer leads. Quanto mais você é visto e tem bons eventos de conversão, mais dados você tem. Dados são ouro.

3. Entenda de funil, margens, taxa de conversão e do nicho do cliente. A oferta é boa pra fazer tráfego? Se o cliente não te contextualiza, busque essas informações.

4. Tráfego não faz venda, comercial faz. Não existe lead curioso, existe objeção e agregação de valor. Tráfego promove. Vendedor vende.

5. Você PRECISA rastrear suas conversões. GTM é tão importante quanto o gerenciador.

6. Sem boa comunicação o cliente fica inseguro e não fecha. Traduza métricas em contexto. Não basta dizer que o CTR está baixo, explique o porquê. Comunique sempre.

7. Seja sincero e não reativo. Se o tráfego está ruim, comunique antes de ser questionado e traga explicação e resolução.

8. Seja proativo. Enxergue o problema antes do cliente e leve a solução junto.

9. Seja organizado com nomenclatura de campanhas e pastas. Desorganização faz você perder dinheiro e clientes.

10. Seja comprometido com os resultados e o dinheiro do seu cliente, afinal ambos são seus também.

11. IA é aliada, não inimiga nem substituta. IA analisa, você refina. O olhar humano AINDA é um diferencial.

12. Cliente precisa ser participativo. Você precisa dele, mas ele também precisa de você. É uma relação de sociedade.

13. Tráfego só impulsiona o que já existe. Não salva negócio e não tem culpa se a oferta ou comercial é ruim. Mas tenha certeza do gargalo antes de apontar culpados.

14. Muita gente começa cobrando barato e cria um posicionamento difícil de reverter. Saiba reconhecer quando você está trazendo resultado.

15. Teste é cultura, não exceção. Tráfego sem teste é achismo.

16. O criativo é o maior alavancador de resultado hoje. O que diferencia campanha boa de ruim é o criativo.

17. Filtre os clientes. Produz criativo? Tem site? Está disposto a fazer? Cobre a parte ou agregue valor. Tudo tem impacto no tráfego.

18. Decisões sem dados são achismo, e métricas sem contexto são só ruído, porque está bom, porque está ruim? O que já rodou? Tem histórico? O que deu certo? O que NÃO deu certo. Aprender a fazer perguntas certas

18. Hoje o conhecimento técnico de gerenciador já não diferencia ninguém. Mas quanto mais você entende de tráfego, mais você entende que ele acontece mais fora do gerenciador do que nele.`

const CAROUSEL_IMAGES = [
  '/trafego-nao-da-certo-01.png',
  '/trafego-nao-da-certo-02.png',
  '/trafego-nao-da-certo-03.png',
  '/trafego-nao-da-certo-04.png',
  '/trafego-nao-da-certo-05.png',
  '/trafego-nao-da-certo-06.png',
  '/trafego-nao-da-certo-07.png',
  '/trafego-nao-da-certo-08.png',
  '/trafego-nao-da-certo-09.png',
  '/trafego-nao-da-certo-10.png',
  '/trafego-nao-da-certo-11.png',
  '/trafego-nao-da-certo-12.png',
  '/trafego-nao-da-certo-13.png',
  '/trafego-nao-da-certo-14.png',
  '/trafego-nao-da-certo-15.png',
  '/trafego-nao-da-certo-16.png',
]

const CAROUSEL_CAPTION = `“Tráfego não dá certo”

Sem estratégia, sem visão, não mesmo.`
...
export default function Home() {
  ...
  useEffect(() => { return useDrag(espRef) }, [useDrag])
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section id="home" className="relative bg-[#0d1b3e] pt-24 pb-6 lg:pt-24 lg:pb-8 px-5 sm:px-8 overflow-hidden">
      ...
      {/* SERVICES */}
      <section id="servicos" className="bg-[#f0f4ff] py-10 sm:py-16 px-5 sm:px-8">
      ...
      {/* O QUE EU ENTREGO */}
      <section className="bg-[#060f22] py-8 sm:py-14 px-5 sm:px-8 relative overflow-hidden">
      ...
      {/* MÉTODO ADS */}
      <section id="metodo" className="bg-[#0d1b3e] py-8 sm:py-14 px-5 sm:px-8 relative overflow-hidden">
      ...
      {/* ESPECIALISTAS */}
      <section className="bg-[#f0f4ff] pt-8 pb-4 sm:pt-12 sm:pb-6 px-5 sm:px-8">
          ...
          <div ref={espRef} className="overflow-hidden -mx-5 sm:-mx-8 cursor-grab select-none" style={{overflowX:'auto',scrollbarWidth:'none'}}>
            {(() => {
              const esp = [
                ...
                { handle: '@priscilladantas.agro', file: '/especialistas/priscilladantas.png' },
                { handle: '@joaommenna', file: '/especialistas/joaommenna.png' },
              ]
              return (
                <div className="marquee-inner-slow">
                  {[...esp, ...esp, ...esp].map((e, i) => (
                    <div key={i} className="flex flex-col items-center gap-3 flex-shrink-0">
                      <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-[24px] overflow-hidden border-2 border-white shadow-lg relative">
                        <Image src={e.file} alt={e.handle} fill className="object-cover" sizes="128px"/>
                      </div>
                      <span className="text-[#0d1b3e] text-xs sm:text-sm font-semibold">{e.handle}</span>
                    </div>
                  ))}
                </div>
              )
      ...
      {/* CERTIFICAÇÃO */}
      <section className="bg-white pt-4 pb-10 sm:pt-6 sm:pb-16 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="bg-[#1d4ed8] px-5 py-2 rounded-xl">
                <span className="text-white font-black text-3xl tracking-wider">PREMIUM</span>
              </div>
              <div className="flex items-center gap-2.5 rounded-2xl border border-gray-200 px-4 py-2.5 bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[380px_1fr] gap-8 md:gap-10 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-600 leading-relaxed mb-4 text-[15px]">
                Gestora de tráfego pago há 2 anos, já atuei no tráfego de diversos especialistas como <strong className="text-[#0d1b3e]">Bettina Rudolph</strong>, <strong className="text-[#0d1b3e]">Leandro Ferrari</strong>, <strong className="text-[#0d1b3e]">Wendell Carvalho</strong>, <strong className="text-[#0d1b3e]">João Menna</strong>, <strong className="text-[#0d1b3e]">Priscilla Dantas Agro</strong>, <strong className="text-[#0d1b3e]">Professor Salomão</strong>, <strong className="text-[#0d1b3e]">Dra. Bel Guerra</strong> entre outros.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4 text-[15px]">
                Responsável por criar, monitorar, analisar e otimizar funis de marketing e campanhas de mídia paga.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4 text-[15px]">
                Produzo relatórios e análises para suportar a tomada de decisão, monitorando o desempenho das campanhas, do funil, o alcance dos KPIs e identificando gargalos e oportunidades de aprimoramento.
              </p>
      ...
      {/* FAQ */}
      <section id="faq" className="bg-[#f0f4ff] py-8 sm:py-14 px-5 sm:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
      ...
      {/* FINAL CTA */}
      <section className="bg-[#0d1b3e] py-10 sm:py-16 px-5 sm:px-8 relative overflow-hidden">
